...
if num_channels < len(wav_files):
    wav_files = wav_files * (num_channels // len(wav_files)) + wav_files[:num_channels % len(wav_files)]
...
class Dealer():
  ...
  def card_audio(self):
    ...
    # Use modulo to wrap the audio channel index
    self.audio_channel = (self.audio_channel + 1) % len(channels)
  ...
  def deal_flop(self):
    ...
    if self.current_flop_index == 0:
      ...
      flop_x = self.players_list[0].cards[0].card_surf.get_width() * 2 + (self.players_list[0].cards[0].card_surf.get_width() * 2 + 30)
    elif self.current_flop_index == 3:
      flop_x = self.players_list[0].cards[0].card_surf.get_width() * 2 + (self.players_list[0].cards[0].card_surf.get_width() * 3 + 50)
    elif self.current_flop_index == 4:
      flop_x = self.players_list[0].cards[0].card_surf.get_width() * 2 + (self.players_list[0].cards[0].card_surf.get_width() * 4 + 70)
